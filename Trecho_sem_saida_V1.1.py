...
Identifica os trechos que configuram ruas sem saída (trechos que possuem uma única conexão com o restante da rede) em uma rede de linhas.
"""

# ==============================================================================
# IDENTIFICAR RUAS SEM SAÍDA
# ==============================================================================
...
def main():
    ...
    # 4. Filtrar as arestas — apenas ruas sem saída verdadeiras
    # Um trecho é rua sem saída se APENAS UM de seus nós tem grau 1.
    # Trechos soltos (ambos os nós com grau 1) são excluídos.
    print("Filtrando os trechos de rua sem saída (excluindo trechos soltos)...")
    dead_end_edges = []
    ...
    for _, edge in gdf_edges.iterrows():
        ...
        start_is_dead = start_point in degree_1_nodes_set
        end_is_dead   = end_point   in degree_1_nodes_set

        # XOR: somente um dos nós tem grau 1 → rua sem saída
        if start_is_dead ^ end_is_dead:
